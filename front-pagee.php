...
?>
    ...
    <div class="container pt-5 pb-5">
        ...
        <p><?php echo $rel -> post_content?></p>
        <img class="img-fluid" src="<?php echo get_the_post_thumbnail_url( $rel -> ID, 'small' ) ?>" alt=""> <!-- Czemu nie działa rozmiar ? -->
        <p><?php echo (get_page_link( $rel -> ID)); ?></p>
        </div>
        <?php endforeach ?>
